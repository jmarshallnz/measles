...
time<-aggregate( cbind( DiseaseName ) ~ NZDep01 +NZDep06+NZDep13+AgeInYears+EthnicityPrioritised + SurvWeek + RptYear,# + Dose1Mths + Dose2Mths, 
                 data = data , FUN=sum)
time_yr<-subset(time, (RptYear %in% c("2007","2008","2009","2010","2011","2012","2013","2014")))

caseyr<-aggregate( DiseaseName ~ AgeInYears, 
                   data = time_yr , FUN=sum)
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tp, aes(x=NZDep, y=cases, fill=Age)) + 
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tp, aes(x=NZDep, y=cases, fill=Ethnicity)) + 
  geom_bar(stat="identity", position="dodge")+
#  theme(text=element_text(size=45))+
  ylab("cases")
@
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tp, aes(x=Age, y=cases, fill=Ethnicity)) + 
  geom_bar(stat="identity", position="dodge")+
#  theme(text=element_text(size=45))+
  ylab("cases")
@
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tp, aes(x=NZDep,y= perCap, fill=Age)) + 
  geom_bar(stat="identity", position="dodge")+
 # theme(text=element_text(size=45))+
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tp, aes(x=NZDep, y=perCap, fill=Ethnicity)) + 
  geom_bar(stat="identity", position="dodge")+
  #theme(text=element_text(size=45))+
  ylab("Per capita per 10000")
@
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tp, aes(x=Age,y= perCap, fill=Ethnicity)) + 
  geom_bar(stat="identity", position="dodge")+
  #theme(text=element_text(size=45))+
  ylab("Per capita per 10000")
@
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tpsub, aes(x=NZDep,y= perCap, fill=Age)) + 
  geom_bar(stat="identity", position="dodge")+
  #theme(text=element_text(size=45))+
  ylab("Per capita per 10000")
@
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tpsub, aes(x=NZDep,y= perCap, fill=Ethnicity)) + 
  geom_bar(stat="identity", position="dodge")+
  #theme(text=element_text(size=45))+
  ylab("Per capita per 10000")
@
...
\begin{center}
<<fig=TRUE,echo=FALSE,width = 15,height=12>>=
ggplot(tpsub, aes(x=Age, y=perCap, fill=Ethnicity)) + 
  geom_bar(stat="identity", position="dodge")+
  #theme(text=element_text(size=45))+
  ylab("Per capita per 10000")
@
...
ggplot(tp, aes(x=merge, y=cases, fill=Ethnicity)) + 
     geom_bar(stat="identity", position="dodge")+
     # theme(text=element_text(size=45))+
     ylab("cases")+theme(axis.text.x = element_text(angle = 90, hjust = 0))
@
\end{center}
\caption{test}
%\label{fig:test}
...
ggplot(tpsub, aes(x=ordert, y=cases, fill=Ethnicity)) +
     geom_bar(stat="identity", position="dodge")+
     # theme(text=element_text(size=45))+
     ylab("cases")+theme(axis.text.x = element_text(angle = 90, vjust=0,hjust = 0))
@
\end{center}
\caption{test}
%\label{fig:test}
...
ggplot(tpsub, aes(x=ordert, y=perCap, fill=Ethnicity)) +
     geom_bar(stat="identity", position="dodge")+
     # theme(text=element_text(size=45))+
     ylab("per capita")+theme(axis.text.x = element_text(angle = 90, vjust=0, hjust = 1))
@
\end{center}
\caption{test}
%\label{fig:test}
...
ggplot(tpsub1, aes(x=ordert,y= perCap, fill=Ethnicity)) +
     geom_bar(stat="identity", position="dodge")+
     # theme(text=element_text(size=45))+
     ylab("per captita")+theme(axis.text.x = element_text(angle = 90, hjust = 0))
@
\end{center}
\caption{test}
%\label{fig:test}
...
\begin{tabular}{lrrrr}
\hline
Age range in years for vaccination & Proportion of the currently na\"{\i}ve population it would cover \\
\hline
2--5 & 0.04\\
5--11 & 0.15\\
5--16 & 0.27\\
