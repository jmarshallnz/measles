...
\item Estimates of the proportion of the currently naive New Zealand population (11\%) requiring additional vaccination to ensure measles does not persist is approximately 28\%, leading to an additional 131,500 vaccinations.
...
@
\caption{Significance of different predictor variables for measles risk factors from 2007-2014}
\label{table:anova}
\end{table}
\vspace{5mm} %5mm vertical space
